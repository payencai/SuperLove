...
import com.love.novalue.adapter.PlatBalanceAdapter;
 ...
 */
public class Balance3Fragment extends Fragment {

    List<MyBalance> myBalances;
    PlatBalanceAdapter totalBalanceAdapter;
    @BindView(R.id.rv_balance)
    RecyclerView rvBalance;
    public Balance3Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_balance3, container, false);
    ...
    private void initView() {
        ...
        totalBalanceAdapter=new PlatBalanceAdapter(myBalances);
