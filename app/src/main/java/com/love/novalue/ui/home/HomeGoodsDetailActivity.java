...
//                    float maxEndX = range + (10 * density) + 5 - DisplayUtil.getScreenWidth(activity);
                float maxEndX = range - DensityUtil.getScreenWidth(HomeGoodsDetailActivity.this);
    ...
    private void initScrollview() {
        barHeight= MarginUtils.getStatusBarHeight(HomeGoodsDetailActivity.this)+DensityUtil.dip2px(HomeGoodsDetailActivity.this,50);
...
//                }
        ...
        mBanner.setImageLoader(new ImageLoader() {
            ...
            public void displayImage(Context context, Object path, ImageView imageView) {
                Glide.with(HomeGoodsDetailActivity.this).load((String) path).into(imageView);
            }
        });
        //设置图片集 合
    ...
    private void scrollRefreshNavigationTag(ScrollView scrollView) {
        ...
        if (scrollY > (llPage3.getTop()-barHeight)) {
            setCurrentTab(2);
    ...
    @OnClick({R.id.tv_buy,R.id.tv_share})
    void OnClick(View view){
        switch (view.getId()){
            case R.id.tv_share:
                startActivity(new Intent(HomeGoodsDetailActivity.this,ShareGoodsActivity.class));
                break;
            case R.id.tv_buy:
                showDialog();
                break;
    ...
    private void showDialog() {
        ...
        View view = LayoutInflater.from(this).inflate(R.layout.dialog_jump_third, null);
        StripedProcessButton stripedProcessButton=view.findViewById(R.id.strip);
