...
import com.love.novalue.adapter.HomeType4Adapter;
 ...
 */
public class HomeType4Fragment extends Fragment {
    HomeType4Adapter homeType4Adapter;
    @BindView(R.id.rv_goods)
    RecyclerView rv_goods;
    List<HomeTypeGoods> homeTypeGoods;
    public HomeType4Fragment() {
    ...
    private void initView() {
        ...
        homeType4Adapter=new HomeType4Adapter(homeTypeGoods);
        rv_goods.setLayoutManager(new LinearLayoutManager(getContext()));
        rv_goods.setAdapter(homeType4Adapter);
    }

    public static HomeType4Fragment newInstance(int type) {
        HomeType4Fragment homeType1Fragment = new HomeType4Fragment();
