...
public class HomeType3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home_type3);
    ...
    private void initView() {
        ...
        for (int i = 0; i <6 ; i++) {
            HomeType3Fragment orderListFragment=HomeType3Fragment.newInstance(i);
