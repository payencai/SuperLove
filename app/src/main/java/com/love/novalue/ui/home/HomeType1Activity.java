...
public class HomeType1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home_type1);
    ...
    private void initView() {
        ...
        for (int i = 0; i <6 ; i++) {
            HomeType1Fragment orderListFragment=HomeType1Fragment.newInstance(i);
